  ...
  fluidRow(
    column(
      ...
      absolutePanel(
        ...
        br(),
        downloadButton(
          "cyar_map_all_area_download", 
          "Download All Area Data"
        )
      )
    )
  )
      ...
      column(
        ...
        fluidRow(
          ...
          tags$p(
            ...
            a(href = "https://treasury.govt.nz/publications/ap/characteristics-children-greater-risk-poor-outcomes-adults-ap-16-01", "Characteristics of Children at Greater Risk of Poor Outcomes as Adults."),
            p(),
          ...
          tags$p(
            ...
            a(href = "https://treasury.govt.nz/publications/ap/using-integrated-administrative-data-identify-youth-who-are-risk-poor-outcomes-adults-ap-15-02", "Using Integrated Administrative Data to Identify Youth Who Are at Risk of Poor Outcomes as Adults."),
            p(),
