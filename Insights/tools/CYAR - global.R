...
df.cyar_csv_rename <- data_frame(ORIGINAL = c("YEAR",	"AREA_CODE",	"AREA_TYPE",	"AGE",
                                              "GENDER",	"RISK_DESC",	"TOTAL",	"COUNT", "PERC"),
                                 RENAMED = c("Year of interest", "Area",	"Area type",	"Age group",	"Gender",	"Risk group",
                                             "Total population",	"Population in risk group", "% of population in risk group"))
