    ...
    column(
      ...
      fluidRow(
        tags$p(
          ...
          strong("Insights"),
          " currently presents information about population change in New Zealand, and about risk, outcomes, and service use for children and youth. Over time ",
          strong("Insights"),
      ...
      fluidRow(
        tags$p(
          "The results from the population change tools are based on the estimated New Zealand resident population, as outlined in ",
          tags$a(
            href = "http://archive.stats.govt.nz/methods/research-papers/topss/identifying-nz-resident-pop-in-idi/discussion.aspx",
      ...
      fluidRow(
        tags$p(
          "The results from the children and youth tools are also based on an estimated New Zealand resident population, as outlined in ",
          tags$a(
            href = "http://archive.stats.govt.nz/methods/research-papers/topss/identifying-nz-resident-pop-in-idi/discussion.aspx",
            "Identifying the New Zealand resident population in the Integrated Data Infrastructure"
          ),
      ...
      fluidRow(
        tags$p(
          "Results are mapped geographically according to people's residential address. This is based on addresses collected by a number of agencies, but in some cases may be out of date or inaccurate. The quality of geographic information in the IDI is discussed in ",
          tags$a(
            href = "http://archive.stats.govt.nz/methods/research-papers/topss/quality-geo-info-idi/results.aspx",
      ...
      fluidRow(
        tags$p(
          ...
          tags$a(
            href = "http://archive.stats.govt.nz/browse_for_stats/snapshots-of-nz/integrated-data-infrastructure/idi-resources.aspx",
      ...
      fluidRow(
        tags$p(
		 ...
		 " and ",
          ...
          ", or contact the Analytics and Insights team at ",
          tags$a(
...
treasury_contact = function() tabPanel(
  ...
  div(
    ...
    column(
      width = 8,
      fluidRow(
        h3(strong("Insights")," was created by Treasury's Analytics and Insights team, with the help of Harmonic Analytics, and using data from Stats NZ's Integrated Data Infrastructure."),
        br(),
        h3("The Analytics and Insights (A&I) team undertakes analysis to inform evidence based policy and practice, supporting: "),
  ...
  div(
    ...
    column(
      ...
      fluidRow(
        ...
        h3("Collection, storage and use"),
        h4("2. No need to disclose personal information"),
        p("The Site can be viewed without the need to disclose any personal information to us."),
        h4("3. Your disclosure of personal information"),
        ...
        h4('5. Use of personal information'),
        ...
        h3('Statistical information and cookies'),
        h4('7. Statistical information collected'),
        ...
        h4('8. Use of statistical information'),
        ...
        h3('Records and disclosure statement'),
        h4('10. Public Records, Official Information and Parliament'),
        ...
        h3('Rights of access and correction '),
        h4('11. Your rights'),
        ...
        h3("Office of the Privacy Commissioner"),
        p("PO Box 10-094"),
  ...
  div(
    ...
    tags$footer(
      ...
      div(
        ...
        style = "float: right; padding-top: 40px; padding-right: 20px;",
        tags$a(
      ...
      div(
        class = "footer-right",
        style = "text-align: center; float: center; padding-right: 30px; padding-top: 40px;",
        tags$a(
          href = "#",
