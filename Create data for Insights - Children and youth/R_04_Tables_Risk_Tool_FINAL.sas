...
data RT_Table1_final; set RT_Table1_2013_final RT_Table1_2014_final RT_Table1_2015_final RT_Table1_2016_final ;
data RT_Table2_final; set RT_Table2_2013_final RT_Table2_2014_final RT_Table2_2015_final RT_Table2_2016_final ;
data RT_Table3_final; set RT_Table3_2013_final RT_Table3_2014_final RT_Table3_2015_final RT_Table3_2016_final ;run;
...
data RT_NAT_table;
set RT_nat_2013_RR3 RT_nat_2014_RR3 RT_nat_2015_RR3 RT_nat_2016_RR3;
run;
...
proc export data=output.RT_Table1_final_rr3  replace
outfile="&path.\tables\RT_REGION_final.csv" dbms=csv;run;

proc export data=output.RT_Table2_final_rr3  replace
outfile="&path.\tables\RT_TA_final.csv" dbms=csv;run;

proc export data=output.RT_Table3_final_rr3  replace
