...
data os_spells2;
set os_spells;
	if year(enddate)=9999 then enddate='30Apr2017'd;
...
** Run from August to May - 22 months - 5 months before and 5 months after the year of interest;
%run_month_OS(project.population_2016_0_24,2016,'01Aug2015'd,197,218);
...
,moe_spi_domestic_status_code as domestic_status
,case when moe_esi_end_date='  ' then 1 else 0 end as sch_enddate_imputed
from moe.student_enrol a left join moe.student_per b
on a.snz_uid = b.snz_uid
where a.snz_uid in (select distinct snz_uid from &population) and moe_esi_start_date is not null
...
%run_month_enr(project.population_2016_0_24,2016,'01Aug2015'd,197,218);
...
%run_month_ter_enr(project.population_2016_0_24,2016,'01Aug2015'd,197,218);
...
**Convert earnings data to Dec 2016 $ values;
...
/*  earners2011(keep=snz_uid earn1-earn12 rename=(earn1-earn12=earn142-earn153))*/
  ...
  earners2016(keep=snz_uid earn1-earn12 rename=(earn1-earn12=earn202-earn213))
  earners2017(keep=snz_uid earn1-earn6 rename=(earn1-earn6=earn214-earn219));
by snz_uid;
array earn(*) earn&m-earn&n;
array rearn(*) rearn&m-rearn&n;
array emp(*) emp&m-emp&n;
do i=&m to &n;
    if i<=48 then rearn(i-&m+1) = earn(i-&m+1)*1214/913;
    else if i<=51 then rearn(i-&m+1) = earn(i-&m+1)*1214/913;
    else if i<=54 then rearn(i-&m+1) = earn(i-&m+1)*1214/918;
    else if i<=57 then rearn(i-&m+1) = earn(i-&m+1)*1214/924;
    else if i<=60 then rearn(i-&m+1) = earn(i-&m+1)*1214/928;
    else if i<=63 then rearn(i-&m+1) = earn(i-&m+1)*1214/935;
    else if i<=66 then rearn(i-&m+1) = earn(i-&m+1)*1214/941;
    else if i<=69 then rearn(i-&m+1) = earn(i-&m+1)*1214/949;
    else if i<=72 then rearn(i-&m+1) = earn(i-&m+1)*1214/953;
    else if i<=75 then rearn(i-&m+1) = earn(i-&m+1)*1214/962;
    else if i<=78 then rearn(i-&m+1) = earn(i-&m+1)*1214/973;
    else if i<=81 then rearn(i-&m+1) = earn(i-&m+1)*1214/979;
    else if i<=84 then rearn(i-&m+1) = earn(i-&m+1)*1214/985;
    else if i<=87 then rearn(i-&m+1) = earn(i-&m+1)*1214/1000;
    else if i<=90 then rearn(i-&m+1) = earn(i-&m+1)*1214/1007;
    else if i<=93 then rearn(i-&m+1) = earn(i-&m+1)*1214/1005;
    else if i<=96 then rearn(i-&m+1) = earn(i-&m+1)*1214/1010;
    else if i<=99  then rearn(i-&m+1) = earn(i-&m+1)*1214/1020;
    else if i<=102 then rearn(i-&m+1) = earn(i-&m+1)*1214/1025;
    else if i<=105 then rearn(i-&m+1) = earn(i-&m+1)*1214/1037;
    else if i<=108 then rearn(i-&m+1) = earn(i-&m+1)*1214/1044;
    else if i<=111 then rearn(i-&m+1) = earn(i-&m+1)*1214/1061;
    else if i<=114 then rearn(i-&m+1) = earn(i-&m+1)*1214/1077;
    else if i<=117 then rearn(i-&m+1) = earn(i-&m+1)*1214/1072;
    else if i<=120 then rearn(i-&m+1) = earn(i-&m+1)*1214/1075;    
    else if i<=123 then rearn(i-&m+1) = earn(i-&m+1)*1214/1081;
    else if i<=126 then rearn(i-&m+1) = earn(i-&m+1)*1214/1095;
    else if i<=129 then rearn(i-&m+1) = earn(i-&m+1)*1214/1093;  
    else if i<=132 then rearn(i-&m+1) = earn(i-&m+1)*1214/1097;   
    else if i<=135 then rearn(i-&m+1) = earn(i-&m+1)*1214/1099;
    else if i<=138 then rearn(i-&m+1) = earn(i-&m+1)*1214/1111;
    else if i<=141 then rearn(i-&m+1) = earn(i-&m+1)*1214/1137;
    else if i<=144 then rearn(i-&m+1) = earn(i-&m+1)*1214/1146;   
    else if i<=147 then rearn(i-&m+1) = earn(i-&m+1)*1214/1157;   
    else if i<=150 then rearn(i-&m+1) = earn(i-&m+1)*1214/1162;
    else if i<=153 then rearn(i-&m+1) = earn(i-&m+1)*1214/1158;  * 1176 Dec 2011 ;  
    else if i<=156 then rearn(i-&m+1) = earn(i-&m+1)*1214/1164;
    else if i<=159 then rearn(i-&m+1) = earn(i-&m+1)*1214/1168;   
    else if i<=162 then rearn(i-&m+1) = earn(i-&m+1)*1214/1171;
    else if i<=165 then rearn(i-&m+1) = earn(i-&m+1)*1214/1169;  * Dec 2012;  
    else if i<=168 then rearn(i-&m+1) = earn(i-&m+1)*1214/1174;
    else if i<=171 then rearn(i-&m+1) = earn(i-&m+1)*1214/1176;  * June 2013; 
    else if i<=174 then rearn(i-&m+1) = earn(i-&m+1)*1214/1187;   
    else if i<=177 then rearn(i-&m+1) = earn(i-&m+1)*1214/1188;  *Dec 2013;
	else if i<=180 then rearn(i-&m+1) = earn(i-&m+1)*1214/1192; *Mar 2014;
    else if i<=183 then rearn(i-&m+1) = earn(i-&m+1)*1214/1195; *Jun 2014;
	else if i<=186 then rearn(i-&m+1) = earn(i-&m+1)*1214/1199; *Sep 2014;
	else if i<=189 then rearn(i-&m+1) = earn(i-&m+1)*1214/1197; *Dec 2014;
    else if i<=192 then rearn(i-&m+1) = earn(i-&m+1)*1214/1195; *Mar 2015;
    else if i<=195 then rearn(i-&m+1) = earn(i-&m+1)*1214/1200; *Jun 2015;
else if i<=198 then rearn(i-&m+1) = earn(i-&m+1)*1214/1204; *sep2015;
else if i<=201 then rearn(i-&m+1) = earn(i-&m+1)*1214/1198; *dec 2015;
else if i<=204 then rearn(i-&m+1) = earn(i-&m+1)*1214/1200; *mar 2016;
else if i<=207 then rearn(i-&m+1) = earn(i-&m+1)*1214/1205; *jun 2016;
else if i<=210 then rearn(i-&m+1) = earn(i-&m+1)*1214/1209; *sep 2016;
else if i<=213 then rearn(i-&m+1) = earn(i-&m+1)*1214/1214; *dec 2016;
else if i<=216 then rearn(i-&m+1) = earn(i-&m+1)*1214/1226; *mar 2017;
else if i<=219 then rearn(i-&m+1) = earn(i-&m+1)*1214/1226; *jun 2017;
end;
do i=1 to dim(rearn);
...
%run_month_earn(project.population_2016_0_24,2016,'01Aug2015'd,197,218);
...
%run_month_it(project.population_2016_0_24,2016,'01Aug2015'd,197,218);
...
%run_month_ben(project.population_2016_0_24,2016,'01Aug2015'd,197,218);
...
if startdate>=intnx('YEAR',DOB,14,'S') and startdate<=enddate;
run;
...
%mend;
%run_month_corr(project.population_2016_0_24,2016,'01Aug2015'd,197,218);
