...
select  z.snz_uid
	...
	,asoc_sub_division_code 	/* code changed by Keith to reflect new moj data Nov 2017 */
...
left join metadata.cor_ov_offence_dim c				/* code changed by Keith to reflect new moj data Nov 2017 */
on a.moj_chg_offence_code=c.code				/* code changed by Keith to reflect new moj data Nov 2017 */
where b.charge_outcome_6cat in ('1Convicted', '2YC proved', '3Discharge w/o conviction', '4adult diversion', 'YC discharge' ) and 
asoc_sub_division_code not in ('151', '152')				/* code changed by Keith to reflect new moj data Nov 2017 */
...
left join metadata.cor_ov_offence_dim c				/* code changed by Keith to reflect new moj data Nov 2017 */
on a.moj_chg_offence_code=c.code				/* code changed by Keith to reflect new moj data Nov 2017 */
where asoc_sub_division_code not in ('151', '152')		/* code changed by Keith to reflect new moj data Nov 2017 */
