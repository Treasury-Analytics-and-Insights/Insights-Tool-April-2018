...
data edu_tabdata&year.;
	set project.pop_&year._0024_service(in=a where=(schter_1519 and age_desc in ('06-14' '15-19'))) project.pop_&year._0024_service(in=b where=(age_desc in ('06-14' '15-19')));
	if b then schter_1519=0;
run;

proc freq data=project.pop_&year._0024_service;
	tables age_desc*schter_1519/missing;
run;

data emp_tabdata&year.;
	set project.pop_&year._0024_service(in=a where=(ben_1524 and age_desc in ('15-19' '20-24'))) project.pop_&year._0024_service(in=b where=(age_desc in ('15-19' '20-24')));
